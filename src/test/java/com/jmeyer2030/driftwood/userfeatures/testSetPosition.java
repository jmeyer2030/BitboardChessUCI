...
import com.jmeyer2030.driftwood.userfeatures.commands.uci.SetPosition;
import com.jmeyer2030.driftwood.userfeatures.commands.uci.UCINewGame;
...
public class testSetPosition {
    ...
    @Test
    @DisplayName("Test that both repetitions, and draw by repetitions are detected")
